...
```text
input: รับ input เข้ามาเป็นอุณหภูมิ หน่วยอุณหภูมิปัจจุบันและหน่วนอุณหภูมิใหม่ที่ต้องการ

output: เป็นอุณหภูมิใหม่ที่ได้รับการแปลงหน่วยแล้ว
...
```text
ลองเขียนสมการออกมาดูก่อนแล้วจึงแปลงให้เป็นภาษาโค้ด
```
...
```text
วิธีสุดท้ายคือการใช้ Celsius เป็นหน่วยกลาง ใช้ condition ตรวจสอบหน่วยเริ่มต้นและแปลงค่าเป็น Celsius ก่อน จากนั้นจึงแปลงจาก Celsius ไปเป็นหน่วยที่ต้องการ ทำให้ลดจำนวนสูตรที่ต้องเขียนและทำให้โค้ดง่ายขึ้น
```
...
```text
เนื่องจากเป็นการเปลี่ยนจาก C เป็น F
```
...
```text
เนื่องจากเป็นการเปลี่ยนจาก F เป็น K
```
...
```text
เนื่องจากเป็นการเปลี่ยนจาก K เป็น R
```
