...
```text
input:
โปรแกรมรับ input เข้ามาเป็น  int ซึ่งเป็นตัวแทนของวันและเดือน

output:
โปรแกรมควรปริ้นว่าฤดูที่วันและเดือนนั้นอยู่คือฤดูใด

constraints:
เดือนใส่เป็นตัวเลขแทนที่จะใส่เป็นชื่อเดือน
```
...
```text
step 1: รับ input เข้ามา 2 ตัวเป็นตัวแทนวันและเดือน
step 2: เข้า condition ว่าหากเป็นวันนี้ของเดือนนี้จะเป็นฤดูใด
step 3: เข้า condition อีกรอบว่าตรงกับวันที่ต้องเปลี่ยนฤดูรึเปล่า
step 4: print ออกมาเป็นฤดูใด
```
...
```text
รับ input เข้ามาเป็นปีแบะเดือน และเข้า condition ว่าต้องเป็นฤดูใดและดูว่าตรงกับวันที่ต้องเปลี่ยนฤดูรึเปล่า และ print ออกมาเป็นฤดูที่ตรงกับ condition
```
...
```text
เพราะเป็นวันที่มากกว่า 21 และเดือนหาร 3 ไม่ลงตัว
```
...
```text
เนื่องจากเป็นเดือนที่หาร 3 ลงตัว
```
...
```text
เนื่องจากเป็นเดือนที่หาร 3 ลงตัวแต่ วันก่อน 21
```
