...
```text
input -  รับ input เข้ามาเป็นสี 2 สี โดยตัว input เป็น string
output - แสดงผลเป็นค่าสีที่ทั้ง 2 สีผสมออกมาได้
constraints - input ที่ได้รับเข้ามาจะเป็นได้แค่ 3 สีเท่านั้น และต้องพิจารณาตัว uppercase และ lowercase ของตัว input ด้วย
```
...
```text
เขียนออกมาว่าแต่ละสีผสมกันแล้วจะได้ออกมาเป็นสีอะไร เขียน command ที่ทำให้ทุกตัวอักษรเป็น lowercase จะได้นำไปเขียนฏค้ดได้ง่ายๆ
```
...
```text
ให้ใส่ input เป็นสองสีไม่ว่าจะเป็นสีที่ต่างกันหรือสีที่เหมือนกันจากนั้นใช้ if elif else เพื่อที่จะให้ output ออกมาเป็นสีที่ได้เป็นผลออกมา และหากเป็นสีเดียวกันก้จะได้เป็นสีเดิมกลับมา
```
...
```text
เนื่องจากเป็นการเทสการใส่สองสีที่เหอืนกันและเทสว่าหากมีตัวพิมพ์ใหญ่โค้ดจะรันได้เช่นเดิมไหม
```
...
```text
เนื่องจากเป็นการเทสการผสมกันของสองสีที่ไม่ซำ้สีที่แล้ว
```
