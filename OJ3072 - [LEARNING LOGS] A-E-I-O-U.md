...
```text
input: รับเข้ามาเป็นอะไรก็ได้ขอแค่เป็นตัวอักษร

output: แสดงจำนวนสระที่อยู่ใน input

constraint: ต้องมีตัวอักษรใน input
```
...
```text
ลองคิดว่าถ้าเราจะนับสระแต่ละตัวเราควรใช้อะไร 
```
...
```text
ใช้ list และ index ในการเขียนโค้ดเนื่องจากสามารถนับได้ที่ละตัวแทนที่จะนับเป็นสระแบบรวมๆ
```
