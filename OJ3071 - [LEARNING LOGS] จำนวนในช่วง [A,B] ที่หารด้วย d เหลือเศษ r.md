...
```text
input: รับเข้ามา 4 ค่าโดยมีค่า A B ตัวหาร และ เศษ

output: ได้ออกมาเป็นจำนวนรอบที่มี เลขหารตัวหารและได้เศษนี้

constraints: A ต้องมากกว่า B และ ตัวหารต้องมากกว่าเศษ
```
...
```text
ลองคิดดูว่าถ้าเรารู้ตัวที่หารแล้วได้เศษนี้ออกมาแล้วเราจะทำให้นับเป็นรอบยังไง
```
...
```text
เหมือนวิธีแรก โดยพอรู้แล้ว 1 เลข จะบวก 1 ครั้งให้กับคำตอบและจะรันไปเรื่อยๆจนกว่าขะหมด range AB
```
...
```text
เลองว่าถ้า B น้อยกว่า A จะเป็นอย่างไร
```
...
```text
เนื่องจากลองเลขที่หารกันเองลงตัว
```
