...
```text
input: รับมา 3 ค่า มีจำนวนหินเล็ก จำนวนหินใหญ่ และความยาวสะพานที่ต้องการ

output: จำนวนหินเล็กที่ต้องใช้

constraints: เป็นได้แค่จำนวนเต็ม
```
...
```text
คิดก่อนว่าถ้าเราจะใช้หินเล็กน้อยที่สุดแสดงว่าเราต้องใช้หินใหญ่ให้มากที่สุด และลองคิดออกมาว่าต้องนำไปดขเาสูตรอะไรถึงจะได้ออกมา
```
...
```text
เป็นเหมือนวิธีแรกคือนำ ความยาวที่ต้องการหารไม่เอาเศษ 5 เนื่องจากหินใหญ่ยาว 5 และใช้ min เลือกว่าระหว่างหินใหญ่ที่คิดได้กับหินใหญ่ที่มีอันไหนเยอะกว่าและให้เลือกอันที่น้อยกว่า และหินเล้กที่ต้องใช้คือ เอาความยาวลบกับจน.หินใหญ่ที่คูณ 5 อยู่
```
