...
```text
input: รับมาเป็นต้นทางกับปลายทาง และน้ำหนัก

output: ราคาที่ต้องจ่าย

constraints: จะคำนวนก้ต่อเมื่อต้นทางและปลายทางมีพร้อมกันในตาราง
```
...
```text
ลองเขียนตามตารางและคำนวนค่าที่ต้องจ่าย
```
...
```text
เหมือนวิธีแรกโดยทำตามตารางและคำนวนค่าเดินทาง
```
