...
| OJ submission ID, if submitted | OJ590394 |
| OJ status | Pass |
...
```text
ช่วยให้สังเกตุว่าการใช้ decimal ไม่เหมือนการใช้ round ของ import math
```
...
```text
เขียนการทำงานหลักของโค้ดด้วยตัวเอง แต่ให้เอไอช่วยเรื่องการปัดเศษแบบมาตรฐาน
```
...
```text
เรียนรู้วิธีการใช้ decimal มากขึ้น
```
